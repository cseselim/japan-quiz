...
<div class="container container_padding">
    ...
    <div class="row">
      <form style="width: 100%" method="post" action="{{route('store.lesson')}}">
        @csrf
          <div class="form-group">
            <label for="exampleInputEmail1" style="font-weight: 700">lesson Name: </label>
            <input type="text" class="form-control" id="lesson_name" name="lesson_name" placeholder="lesson Name" required>
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1" style="font-weight: 700">Lesson Discription: </label>
            <textarea class="form-control" id="lesson_discription" name="lesson_discription" placeholder="Lesson Discription" required></textarea>
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1" style="font-weight: 700">video_url: </label>
            <input type="text" class="form-control" id="video_url" name="video_url" placeholder="lesson Name" required>
          </div>
{{--          <div class="form-group">--}}
{{--            <label for="exampleInputEmail1" style="font-weight: 700">Word Title: </label>--}}
{{--            <input type="text" class="form-control" id="word_title" name="word_title" placeholder="Word Title" required>--}}
{{--          </div>--}}
{{--          <div class="form-group">--}}
{{--            <label for="exampleInputEmail1" style="font-weight: 700">Quiz Title: </label>--}}
{{--            <input type="text" class="form-control" id="quiz_title" name="quiz_title" placeholder="Word Title" required>--}}
{{--          </div>--}}
