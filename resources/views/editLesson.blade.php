...
<div class="container container_padding">
    ...
    text-transform: capitalize;">lesson list</a>
        </div>
    </div>
    <div class="row">
      ...
      <form style="width: 100%" method="post" action="{{route('lesson.update')}}">
        @csrf
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="lesson_name" name="lesson_name" value="{{$data->lesson_name}}" required>
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1" style="font-weight: 700">Lesson Discription: </label>
            <textarea class="form-control" id="lesson_discription" name="lesson_discription" placeholder="Lesson Discription" required>{{$data->lesson_discription}}</textarea>
          </div>
          <div class="form-group">
